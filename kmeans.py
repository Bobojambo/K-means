...
def kmeans(k, epsilon=0, distance='euclidian'):
    ...
    #get the number of rows (instances) and colums (features) from the data
    num_instances, num_features = dataset.shape
    #define k centroids (how many clusters we do want to find) chosen randomly
